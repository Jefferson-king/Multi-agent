...
class MultiAgentSystem:
    ...
    def _init_llm(self) -> BaseChatModel:
        ...
        if llm_config["provider"] in ("dashscope", "deepseek"):
            base_url = llm_config.get(
                "base_url",
                "https://api.deepseek.com/v1" if llm_config["provider"] == "deepseek" else "https://dashscope.aliyuncs.com/compatible-mode/v1"
            )
            return ChatOpenAI(
